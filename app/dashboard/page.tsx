...
const DashboardPage = () => {
    ...
    return (
        <div>
            {selectedHoliday ? (
                <Dashboard selectedHoliday={selectedHoliday} onClearSelection={() => setSelectedHoliday(undefined)}></Dashboard>
            ) : (
                <HolidaySelector holidays={allHolidayData} onHolidaySelect={onHolidaySelect} />
            )}
        </div>
    );
};
